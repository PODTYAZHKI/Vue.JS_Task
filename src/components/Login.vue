...
export default{
	...
	computed: {
		...
		// LoginError() {
		// 	return this.error['login'] = 'Неверный адрес электронной почты';
		// }
	},
	...
	methods: {
		...
		validateLogin(value){
			if (this.isPressed){
				...
				else this.error['login'] = 'Неверный адрес электронной почты';
			}
		},
		validatePhone(value){
			if (this.isPressed){
				...
				else this.error['phone'] = 'Неверный телефон';
			}
		},
		validatePassword(value){
			if (this.isPressed){
				...
				else this.error['password'] = 'Неверный пароль';
			}
		},
		// validatePassword(value){
		// 	if (this.isPressed){
		...
		ActionPost: function(e) {
			...
			if(!this.isLoginValid || !this.isPhoneValid || !this.isPasswordValid) {
				e.preventDefault();
				if (!this.isLoginValid) this.error['login'] = 'Неверный адрес электронной почты';
				if (!this.isPhoneValid) this.error['phone'] = 'Неверный телефон';
				if (!this.isPasswordValid) {this.error['password'] = 'Неверный пароль'; this.$forceUpdate()}
